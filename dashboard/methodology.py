            ...
            dbc.AccordionItem([
                _copy_btn(_section_text(
                    ...
                    tables=[(
                        ...
                        [
                            ["2026-07-06", "Dynamic thresholds re-paired with the window unification: every call site now computes Ray 7-step thresholds on the ACTIVE (windowed) score series the classifier sees, not full-history columns; Regime Map geometry/lines/hover labels track the latest dynamic values in dynamic mode", "8"],
