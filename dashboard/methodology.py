                ...
                _copy_btn(_section_text(
                    ...
                    tables=[(
                        ...
                        [
                            ...
                            ["2026-07-06", "User Guide added (/guide): 9-lesson training course on the Ray-reviewed tools — machine big picture, debt-cycle hook, dials, chips/thresholds/windows, map, stress-vs-stage, productivity/order, diversification, reading routine; live data per lesson; Ray pedagogy pass (3 newcomer traps front-loaded)", "— (education, no formula change)"],
                            ["2026-07-06", "Dynamic thresholds re-paired with the window unification: every call site now computes Ray 7-step thresholds on the ACTIVE (windowed) score series the classifier sees, not full-history columns; Regime Map geometry/lines follow the SELECTED month's dynamic thresholds when stepping back in time; hover labels are per-row (each month judged against its own thresholds)", "8"],
