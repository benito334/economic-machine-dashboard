...
| **UK** | Rich | Monthly CPI dead 2025-03 → IMF bridge; no daily FTSE (monthly-proxy vol); no DSR | **ONS API (api.beta.ons.gov.uk) — free, unregistered — highest-value UK find** for live monthly CPI (+ could replace aging retail/IP) |
